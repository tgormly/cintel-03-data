...
- Interactive app: [cintel-03-data](https://tgormly.shinyapps.io/cintel-03-data/) - see MT Cars tab and Penguins tab
- Repository: [cintel-03-data](https://github.com/tgormly/cintel-03-data)
